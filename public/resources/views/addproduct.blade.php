...
<div class="row">
	...
	<div class="col-md-2 pull-left">
		<div class="btn-group">
			<button type="button" class="btn btn-default dropdown-toggle col-md-12" data-toggle="dropdown">
				All Categories <i class="fa fa-sort" aria-hidden="true"></i>
			</button>
	...
	<div class="col-md-2 pull-left">
		<div class="btn-group">
			<button type="button" class="btn btn-default dropdown-toggle col-md-12" data-toggle="dropdown">
				All Inventory <i class="fa fa-sort" aria-hidden="true"></i>
			</button>

			<ul class="dropdown-menu" role="menu">
				<li><a href="#">All Inventory</a>
				</li>
				<li><a href="#">Low Stock Alert</a>
				</li>
				<li><a href="#">Out Of Stock Alert</a>
				</li>
			</ul>
		</div>
	</div>
	<div class="col-md-2">
		<button type="button" class="btn btn-default pull-left">Total : 39</button>
	</div>
	<div class="col-md-4">
		<a href="javascript:;" onclick="jQuery('#modal-6').modal('show', {backdrop: 'static'});" class="btn btn-primary pull-right">Create Product</a>
	</div>
</div>
<br>
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<div class="row">
					<div class="col-md-6">
						<table class="table table-bordered datatable table-striped" id="datatable-buttons">
							<thead>
								<tr>
									<th>Name</th>
									<th>Category</th>
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left input_mask">
										...
										<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
											<input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Item Name">
											<span class="fa fa-cube form-control-feedback left" aria-hidden="true"></span>
										</div>

										<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
											<select class="select2_single form-control" tabindex="-1">
												<option value="AK">Uncategorized</option>
												<option value="HI">Buah</option>
												<option value="CA">Sayur</option>
												<option value="NV">Makanan</option>
											</select>
										</div>
										<div class="x_title">
											Variant
